...
.session-card .num em { font-style: italic; }
...
.session-card h3 em { font-style: italic; color: var(--accent); font-weight: 400; }
...
.session-card .parts li b { font-family: var(--serif); font-style: italic; font-weight: 400; color: var(--accent-warm); font-size: 13px; width: 52px; flex-shrink: 0; letter-spacing: 1px; }
...
.session-hero h1 em { font-style: italic; color: var(--accent); font-weight: 400; }
...
.sidebar li a .pnum { font-family: var(--serif); font-style: italic; color: var(--accent-warm); margin-right: 10px; font-size: 12px; letter-spacing: 1px; }
...
.part-section .part-head .pnum { font-family: var(--serif); font-style: italic; font-size: 18px; color: var(--accent-warm); letter-spacing: 1px; }
...
.slide-card .num-badge { position: absolute; top: 14px; left: 14px; font-family: var(--serif); font-style: italic; font-size: 13px; color: var(--accent); background: rgba(10,10,11,0.7); backdrop-filter: blur(8px); padding: 4px 10px; border-radius: 2px; letter-spacing: 1px; }
...
.lb .counter { position: absolute; bottom: 32px; left: 50%; transform: translateX(-50%); font-family: var(--serif); font-style: italic; font-size: 14px; color: var(--text-2); letter-spacing: 2px; }
